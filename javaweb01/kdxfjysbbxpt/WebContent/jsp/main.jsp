		  ...
		  <div class="container-fluid">
		    <div class="navbar-header">
		      <a class="navbar-brand" style="padding-top:5px;padding-bottom: 5px;" href="#">
		        <img alt="Brand" src="/kdxfjysbbxpt/img/ifly-logo2.png">
		      </a>
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      <ul class="nav navbar-nav navbar-right">
		        ...
		        <li><a href="/kdxfjysbbxpt/QuitServlet" class="menu"><span class="glyphicon glyphicon-off"></span>&nbsp;&nbsp;退出</a></li>
		      </ul>
		    </div><!-- /.navbar-collapse -->
		  </div>
		</nav>
...
<script src="/kdxfjysbbxpt/js/jquery.js"></script>
<script src="/kdxfjysbbxpt/js/bootstrap.min.js"></script>
<script>
